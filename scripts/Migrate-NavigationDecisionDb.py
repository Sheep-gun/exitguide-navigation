...
ROLE_ALIASES: dict[str, tuple[str, tuple[tuple[str, str, float], ...], str, bool]] = {
    ...
    "membership.hub": ("멤버십 관리 허브", (("멤버십 관리", "ko", 1.0), ("멤버쉽 관리", "ko", 1.0), ("구독 관리", "ko", .98), ("프리미엄", "ko", .86), ("와우 멤버십", "ko", .98), ("membership", "en", .92), ("manage subscription", "en", 1.0), ("premium", "en", .86)), "low", False),
